...
public class ArtActivity extends AppCompatActivity {
    ...
    ActivityResultLauncher<Intent>activityResultLauncher;//galeriye gitmek icin bu kodu
    ActivityResultLauncher<String>permissionLauncher;//izin istemek icinde bu isimize yariyacak
